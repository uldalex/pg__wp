...
<?php
if ( ! class_exists( 'BEM_Walker_Nav_Menu' ) ) :
	/**
	...
	class BEM_Walker_Nav_Menu extends Walker_Nav_Menu {
		...
		public function start_lvl( &$output, $depth = 0, $args = null ) {
			...
			$output .= "{$n}{$indent}<div class='main-nav__sublist-wrapper  main-nav__sublist-wrapper--lvl-2'><ul class='main-nav__list  main-nav__list--lvl-2'>{$n}";
		}
		...
		public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
			...
			if ( $this->has_children ) {
				$classes[] = 'main-nav__item--has-child';
			}
